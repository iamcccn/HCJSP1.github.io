        ...
        function Time(Now,image){
            ...
            if(Now >=6 && Now < 12) {
                ...
                document.writeln('<img src="/images/Morning1.png" width="950px">');

                
                        }
            else if (Now >=1 && Now < 3 ){
                alert("GOOD-NOON!");
                document.writeln('<img src="/images/Noon.png" width="1100px">');
            }
            else if(Now >= 3 && Now <=5 ){
                alert("GOOD-AFTERNOON");
                document.writeln('<img src="/images/Afternoon0.jpg" width="1250px"">');
            }
            else if(Now >= 18 && Now < 24){
                alert("GOOD-NIGHT");
                document.writeln('<img src="/images/Night.png">');
            }
